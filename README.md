...
```xml
  <properties>
    <!-- e.g. ${project.build.directory}/refdocs -->
    <refdocs.dir>...</refdocs.dir>
    <!-- see available versions: https://repo.spring.io/release/io/spring/docresources/spring-doc-resources/ --> 
    <spring-doc-resources.version>...</spring-doc-resources.version>
    <refdocs.build.directory>...</refdocs.build.directory>
  </properties>
```
...
<plugin>
	...
	<configuration>
		...
		<attributes>
			...
			<spring-project-docs-version>${revision}</spring-project-docs-version>
